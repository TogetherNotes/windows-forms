...
namespace TogetherNotes.ViewModel
{
    public class UsersVM : ViewModelBase
    {
        ...
        private void ShowAdmin(object obj) { CurrentUserView = new ManageAdminVM(); }
        private void ShowMusician(object obj) { CurrentUserView = new ManageAdminVM(); }
        private void ShowRestaurant(object obj) { CurrentUserView = new ManageAdminVM(); }
